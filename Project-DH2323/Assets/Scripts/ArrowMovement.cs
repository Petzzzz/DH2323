...
public class ArrowMovement : MonoBehaviour
{
    ...
    public float shootForce = 2; //Need to get to calculate start speed based on energy 
    ...
    void rotateArrow()
    {
        ...
        float theta = (-1) * Mathf.Atan2(yVelocity, Mathf.Sqrt(Mathf.Pow(xVelocity, 2) + Mathf.Pow(zVelocity, 2))) * 180/Mathf.PI;
        transform.eulerAngles = new Vector3(theta, transform.eulerAngles.y, transform.eulerAngles.z); 
    }
